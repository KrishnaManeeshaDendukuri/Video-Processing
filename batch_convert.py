...
#directory containing all the videos to be considered for feature extraction
data_root = '/data/videos'
# this is a csv fie with file path and encoded labels i.e. list of integers: {file_path , [1,2,3]}
csv_path = '/data/artifacts/encoded_labels_with_abs_path.csv'
#converting the csv into a dictionary with key: video_path anf value: list of labels
...
for file_name in glob.glob(data_root + '/*'):
    ...
    try:
        #path for pb files (feature files produced by Mediapipe)
        tmp_dir = '/data/tmp_pb/'
        #path for tfrecord files (YT8M dataset format)
        dst_dir = '/data/tfrecords/'
